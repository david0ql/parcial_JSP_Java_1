...
String usuario="" ; 
String clave="" ;
String nombre="" ; String estado_civil="" ; 
String direccion="" ; 
String email="" ; int id_permiso=0; 
...
//Usamos preparedStaments para más seguridad
   ...
   sentencia=conexion.prepareStatement(query); sentencia.setString(1, usuario);
   sentencia.setString(2, clave); sentencia.setString(3, nombre); sentencia.setString(4,
   estado_civil); sentencia.setString(5, direccion); sentencia.setString(6, email);
   sentencia.setInt(7, id_permiso); sentencia.setInt(8, id_afiliciacion);
   sentencia.setInt(9, id_ips); sentencia.setInt(10, id_grupo_ingreso);
   sentencia.setBoolean(11, id_estado_afiliacion); sentencia.executeUpdate();
