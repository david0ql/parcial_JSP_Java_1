...
HttpSession sesion=request.getSession(); //Recibimos los parámetros que nos hayan enviado por post 
int id_usuario=0; String query="" ; //Intentamos settear los parámetros 
try{
