   ...
   <body class="sb-nav-fixed">
      <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
         ...
         <div
            ...
            <button class="btn btn-primary rounded-pill px-3 mb-2 mb-lg-0"
               data-bs-toggle=modal data-bs-target="#crear_cita"><span
               class="d-flex align-items-center"><span class=small>Solicitar
            Cita</span></span></button>
         </div>
         <!-- Navbar-->
            ...
            <li class="nav-item dropdown">
               ...
               <ul class="dropdown-menu dropdown-menu-end"
                  ...
                  <li><a class="dropdown-item"
                     href="validaciones/logout.jsp">Logout</a></li>
               </ul>
            </li>
         </ul>
      </nav>
      <div id="layoutSidenav">
         ...
         <div id="layoutSidenav_content">
                        ...
                        <tbody>
                           ...
                           <tr>
                              ...
                              <td><button type="button"
                                 ...
                                 data-bs-target="#exampleModal<%=rs.getString("id_cita_medica")%>">Editar</button>
                              </td>
                              <% if(sesion.getAttribute("id_permiso").equals("1")){
                                 %>
                              <td><a href="validaciones/eliminar_citas.jsp?id=<%=rs.getString("id_cita_medica")%>"><button
                                 type="button"
                           ...
                           <div class="modal fade"
                              id="exampleModal<%=rs.getString("id_cita_medica")%>" tabindex="-1"
                              role="dialog"
                              ...
                              <div class="modal-dialog" role="document">
                                 <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                       <form
                                          action="validaciones/cambiar_cita.jsp">
                                          <input type="hidden"
                                             name="id_cita"
                                             value="<%=rs.getString("id_cita_medica")%>">
                                          <input type="text"
                                             readonly=""
                                             value="<%=rs.getString("usuario")%>">
                                          <br>
                                          <select name="solicitudes"
                                             id="">
                                             <% //Select afiliación
                                                ...
                                                %>
                                             <option
                                                value="<%=rs2.getString("id_solicitud")%>
                                                ">
                                          ...
                                          <br>
                                          <button
                                             class="mx-3 btn btn-primary rounded-pill btn-lg"
                                             id=submitButton
                                             type=submit>Cambiar
                                          datos
                                          </button>
            ...
            <!--modal crear citas-->
            <div class="modal fade" id="crear_cita" tabindex=-1
               aria-labelledby=feedbackModalLabel aria-hidden=true>
               <div class="modal-dialog modal-dialog-centered">
                  <div class="modal-content">
                     <div
                        class="modal-header bg-gradient-primary-to-secondary p-4">
                        <h5 class="modal-title font-alt text-black"
                           id="feedbackModalLabel">Agendar cita</h5>
                        <button class="btn-close btn-close-white" type="button"
                           data-bs-dismiss="modal" aria-label=Close></button>
                     </div>
                     <div class="modal-body border-0 p-4">
                        <form id=contactForm
                           action="validaciones/agendar_cita.jsp"
                           method="POST">
                           <input type="hidden" name="id_usuario"
                              value="<% out.print(sesion.getAttribute("id_usuario")); %>">
                           <div class="form-floating mb-3">
                              <input class="form-control" readonly=""
                                 type="text" placeholder="Ingresa tu Nombre"
                                 required
                                 value="<% out.println(sesion.getAttribute("nombre")); %>">
                              <label for="nombre">Nombre</label>
                           </div>
                           <div class="form-floating mb-3">
                              Tipo consulta
                              <select class="custom-select" name="solicitud"
                                 required>
                                 <% //Select afiliación
                                    ...
                                    rs=sentencia.executeQuery();
                                    while(rs.next()){ %>
                                 <option value="<%=rs.getString("id_solicitud")%>">
                                    <%=rs.getString("nombre")%>
                                 </option>
                                 <% } %>
                              </select>
                           ...
                           <div class="d-grid">
                              <button
                                 class="mx-3 btn btn-primary rounded-pill btn-lg"
                                 id=submitButton type=submit>Registrate
                              </button>
                           </div>
                        </form>
                     </div>
